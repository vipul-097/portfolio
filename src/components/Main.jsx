...
<h1 className='xl:w-[50%]  w-[100%] text-3xl  xl:font-medium  font-bold bg-gradient red xl:mb-5 mb-2 xl:mb-2   '> <span className='xl:text-5xl   bg-gradient-to-r from-green-400 to-blue-500 inline-block text-transparent bg-clip-text xl:mb-2 '> Hello I'm Vipul Sharma </span>  <br />full stack developer </h1>
<p className='xl:w-[50%]  w-[100%]  xl:font-normal w-full xl:text-base text-xs mb-4  xl:mb-6'>As a MERN stack developer,I crafted dynamic web applications.My focus  is on creating responsive ,efficient user experiences. </p>
<div>
